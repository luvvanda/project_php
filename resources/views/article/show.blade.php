...
<div class="container mt-5">
  ...
  @else
    ...
    <div class="list-group-item">
      ...
      <a href="/comment/{{ $comment->id }}/edit" class="btn btn-secondary btn-sm">Редактировать комментарий</a>
      <a href="/comment/{{ $comment->id }}/delete" class="btn btn-danger btn-sm ms-2">Удалить комментарий</a>
    @endcan
      </div>
    </div>
  @endforeach
