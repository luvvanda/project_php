...
<form action="/comment/{{$comment->id}}/update" method="POST" class="mt-4" >
  ...
  <div class="mb-3">
      ...
      <textarea class="form-control" id="desc" name="desc">{{ $comment->desc}}</textarea>
  </div>
  <button type="submit" class="btn btn-primary">Сохранить</button>
</form>
<!-- <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"></script>
<scrtipt src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.min.js"></scrtipt>
<script>
